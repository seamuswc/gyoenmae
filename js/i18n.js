(function () {
  ...
  const translations = {
    en: {
      ...
      upfrontDesc: 'Full contract amount paid in advance at signing. No guarantor required.',
      residents: 'Residents',
      monthly: 'Monthly payment',
      monthlyDesc: '¥200,000 per month for Japan residents. Guarantor required.',
    ...
    ja: {
      ...
      nonResidents: '非居住者',
      upfront: '一括前払い',
      upfrontDesc: '契約時に契約総額を前払いします。保証人不要です。',
      residents: '居住者',
      monthly: '月払い',
      monthlyDesc: '日本の居住者は月額¥200,000です。保証人必要です。',
